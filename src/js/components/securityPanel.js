        ...
        return (
          <div className="security-panel">
            ...
            <div className="change-password">
              <div className="change-password-title">Change master password</div>
              <input className="old-password" placeholder="Old password" type="password"/>
              <input className="new-password" placeholder="New password" type="password"/>
